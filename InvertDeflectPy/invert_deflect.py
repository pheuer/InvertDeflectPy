...
def test_1d():
    ...
    file = os.path.join('C:\\','Users','pheu','Box','pheuer','Research',
                        'Experiments and Projects',
                        '2022 Testing PRad Algorithms',
                        'PradTesting','gaussian_charge_cylinder',
    ...
    obj = InvertDeflect(I, N_cell_min=50, tolerance=1e-4)
    obj.run()
...
def test_2d(plots=True):
    ...
    file = os.path.join('C:\\','Users','pvheu','Box','pheuer','Research',
                        'Experiments and Projects',
                        '2022 Testing PRad Algorithms',
                        'PradTesting','gaussian_charge_blob', 'Radiographs',
    ...
    obj = InvertDeflect(I, N_cell_min=4, tolerance=1e-2, max_iter=60,
                        plots=plots)
    obj.run()
